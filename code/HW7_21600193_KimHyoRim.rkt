...
; (8) purpose: to look up the RBMFAE-Value of identifiers in the Store
...
; (11) purpose: to restrict memory allocation
...
; (13) purpose: to evaluate RBMFAE expression by use store-passing style
...
;            -> Value*Store
; (14) purpose: to evaluate RBMFAE RBMFAE expression by use store-passing style
