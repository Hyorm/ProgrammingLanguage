...
; (6) purpose: to look up the address of identifiers in the DefredSub
...
; (8) purpose: to look up the BFAE-Value of identifiers in the Store
...
; (12) purpose: to restrict memory allocation
...
; (13) interp-two: BFAE BFAE DefrdSub Store (Value Value Store -> Value*Store) -> Value*Store
; (14) purpose: to evaluate BFAE BFAE expression by use store-passing style
...
; (16) purpose: to evaluate BFAE expression by use store-passing style
